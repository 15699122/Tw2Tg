...
- Current WQ-WS-05 package assembly/ZIP build and browser load: `NOT RUN`; only the Windows Tauri executable was built. Prior-revision assembly and user-reported browser loads remain historical evidence. Signing/release gate: `NOT RUN`.
